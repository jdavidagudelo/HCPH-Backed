...
public class PatientService {
	...
	public Patient crearPacienteVacio(Integer creator) {
		...
		try{
			...
			this.savePersonName(person, 1, null, null, null, null, creator);
			this.savePersonAddress(person, 1, null, null, null, null, null, null, null);
	...
	public PersonName savePersonName(Person person, Integer prefered, String primerNombre, String segundoNombre, String primerApellido, String segundoApellido, Integer creator) {
	...
	public PersonAddress savePersonAddress (Person person, Integer prefered, String direc, Integer city, String zone, String phone1, String phone2, String email, EventAddress eventAddress) {
		...
		try {
			...
			personAddress.setVoided((short)0);
 	...
 	private PatientIdentifier savePatientIdentifier(Patient patient, Integer patientIdentifier, String identifier, Integer creator){
		...
		try{
			...
			patientIdent.setPreferred(1);
			patientIdent.setUuid(UUID.randomUUID().toString());
			patientIdent.setVoided((short)0);
 	...
 	public void updatePatient(PersonComplete personComplete, Integer user) {
		...
		try{
			...
			if(padrDB == null)
				padrDB = this.savePersonAddress(personDB, 1, personComplete.getAddress(), personComplete.getCity(), personComplete.getZone(), personComplete.getPhone1(), personComplete.getPhone2(), personComplete.getEmail(), personComplete.getEventAddress());
			else {
