...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:hl7="urn:hl7-org:v3" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="xd hl7 xsi xhtml" version="1.0">
    ...
    <xsl:template match="hl7:component/hl7:nonXMLBody">
        <xsl:choose>
            ...
            <xsl:when test="hl7:text/hl7:reference">
                <iframe name="nonXMLBody" id="nonXMLBody" width="100%" weight="600" src="{hl7:text/hl7:reference/@value}"/>
            </xsl:when>
        ...
        <xsl:choose>
            <xsl:when test="//hl7:regionOfInterest[@ID=$imageRef]">
                ...
                <xsl:choose>
                    ...
                    <xsl:when test="//hl7:regionOfInterest[@ID=$imageRef]//hl7:observationMedia/hl7:value/hl7:reference/@value">

                        <xsl:variable name="mediaIdRoot" select="//hl7:regionOfInterest[@ID=$imageRef]//hl7:observationMedia[hl7:value/hl7:reference]/hl7:id/@root"/>
                        <xsl:variable name="mediaIdExt" select="//hl7:regionOfInterest[@ID=$imageRef]//hl7:observationMedia[hl7:value/hl7:reference]/hl7:id/@extension"/>
                        ...
                        <xsl:element name="img">
                            ...
                            <xsl:attribute name="src">
                                <xsl:value-of select="//hl7:regionOfInterest[@ID=$imageRef]//hl7:observationMedia/hl7:value/hl7:reference/@value"/>
                            </xsl:attribute>
                        </xsl:element>
                    </xsl:when>
                </xsl:choose>
            ...
            <xsl:otherwise>
                ...
                <xsl:if test="//hl7:observationMedia[@ID=$imageRef]/hl7:value[@mediaType='image/gif' or @mediaType='image/jpeg']">
                    ...
                    <xsl:element name="img">
                        ...
                        <xsl:attribute name="src">
                            <xsl:value-of select="//hl7:observationMedia[@ID=$imageRef]/hl7:value/hl7:reference/@value"/>
                        </xsl:attribute>
                    </xsl:element>
                </xsl:if>
            </xsl:otherwise>
    ...
    <xsl:template match="*" mode="handleSectionTextAttributes">
        ...
        <!-- Write @class attribute if there data for it -->
            ...
            <xsl:choose>
                ...
                <xsl:otherwise>
                    <!-- For CDAr3 we might get a slew of attributes not catered for explicitly, 
                        but supposedly HTML compatible so just add them as-is -->
                        ...
                        <td class="td_label">
                            ...
                            <span style="float:right;">
                                <xsl:if test="hl7:patient/hl7:birthTime[@value]">
                                    <i>
                                        <xsl:choose>
                                            <xsl:when test="hl7:patient/hl7:deceasedInd[@value='true' or @nullFlavor] | hl7:patient/hl7:deceasedTime">
                                                <xsl:call-template name="getLocalizedString">
                                    ...
                                    <b>
                                        ...
                                        <xsl:if test="hl7:patient/hl7:deceasedInd[@value='true' or @nullFlavor] | hl7:patient/hl7:deceasedTime">
                                            <xsl:text> - </xsl:text>
                                            <xsl:choose>
                                                <xsl:when test="hl7:patient/hl7:deceasedTime[@value]">
                                                    <xsl:call-template name="show-timestamp">
                                                        <xsl:with-param name="in" select="hl7:patient/hl7:deceasedTime"/>
                                                    </xsl:call-template>
                                                </xsl:when>
                                                <xsl:when test="hl7:patient/hl7:deceasedInd[@nullFlavor]">
                                                    <xsl:call-template name="show-nullFlavor">
                                                        <xsl:with-param name="in" select="hl7:patient/hl7:deceasedInd/@nullFlavor"/>
                                                    </xsl:call-template>
                                                </xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:call-template name="getLocalizedString">
                                        ...
                                        <xsl:variable name="comparedate">
                                            <xsl:choose>
                                                <xsl:when test="hl7:patient/hl7:deceasedTime[@value]">
                                                    <xsl:value-of select="hl7:patient/hl7:deceasedTime/@value"/>
                                                </xsl:when>
                                                <xsl:when test="not(hl7:patient/hl7:deceasedInd or hl7:patient/hl7:deceasedInd[@value='true' or @nullFlavor] or hl7:patient/hl7:deceasedTime)">
            ...
            <xsl:for-each select="$in/node()">
                <xsl:choose>
                    ...
                    <xsl:when test="self::hl7:postBox">
                        ...
                        <xsl:value-of select="."/>
                        <xsl:if test="following-sibling::hl7:*[1][string-length(@value) > 0 or @code]">
                            <br/>
                        </xsl:if>
                    </xsl:when>
                    <!-- DTr2 -->
                    ...
                    <xsl:when test="self::hl7:city">
                        ...
                        <xsl:if test="following-sibling::hl7:*[1][string-length() > 0]">
                            <br/>
                        </xsl:if>
                    </xsl:when>
                    <!-- DTr2 -->
