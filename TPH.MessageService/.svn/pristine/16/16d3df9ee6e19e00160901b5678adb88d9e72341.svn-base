...
import com.artica.telesalud.tph.message.service.properties.IN000032UV01XPathProperties;
 ...
 * plantilla XML identificada con el codigo RCMR_IN000032UV01, y a partir de
 ...
 *
 */
public class IN000032UV01XMLParser extends XMLParser{
	private IN000032UV01XMLParser() {
	}

	private static final IN000032UV01XPathProperties XPATH_PROPERTIES = IN000032UV01XPathProperties
			.getInstance();
	private static final IN000032UV01XMLParser INSTANCE = new IN000032UV01XMLParser();

	public static IN000032UV01XMLParser getInstance() {
		return INSTANCE;
	}
